...
public class FilaDeVacinacaoAdm extends javax.swing.JFrame {

    //Talvez puxar uma vez do banco para cada prioridade e a cada extração definir ordem de idade
    public FilaDeVacinacaoAdm() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        jPanel1.add(button2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 80, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 350, 80, 30));
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        TelaAdm telaAdmVoltarFila = new TelaAdm();
        telaAdmVoltarFila.setVisible(true);
        setLocationRelativeTo(null);
        this.dispose();
        ...
        if (cpf.equals(compare)) {
            ...
            try {
                ...
                while (rs.next()) {   //Talvez o objeto "o" possa ser retirado
                    ...
                    TelaPesquisaPessoa pesquisa = new TelaPesquisaPessoa(paciente);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FilaDeVacinacaoAdm().setVisible(true);
            }
        });
    }
