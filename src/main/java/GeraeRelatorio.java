...
public class GeraeRelatorio extends javax.swing.JFrame {

    public GeraeRelatorio() {
        initComponents();
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        TelaAdm voltarRelatorioAdm = new TelaAdm();
        voltarRelatorioAdm.setVisible(true);
        this.dispose();
    ...
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        ...
        try {
            ...
            String dataini = "\"" + data1 + "\"";
            String datfin = "\"" + data2 + "\"";
            String sql = ("SELECT * FROM p_vacinadas where Data_da_Vacinação BETWEEN" + dataini + "AND" + datfin + " AND idade >=70 <90");
            Connection cn = SqlConnection.obterConexao();
        ...
        try {
            ...
            Calendar data111111 = Calendar.getInstance();
            Calendar data222222 = Calendar.getInstance();

            try {
                data111111.setTime(sdf.parse(dataIniTextField.getText()));
                data222222.setTime(sdf.parse(dataFinalTextField.getText()));

            } catch (Exception e) {
            }
            diascontados = data222222.get(Calendar.DAY_OF_YEAR) - data111111.get(Calendar.DAY_OF_YEAR);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeraeRelatorio().setVisible(true);
            }
        });
    }
