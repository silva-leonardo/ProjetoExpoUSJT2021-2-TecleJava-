...
public class ListaDeAtendentes extends javax.swing.JFrame {

    public ListaDeAtendentes() {
        initComponents();
        try {
    ...
    private void removerButaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removerButaoActionPerformed
        ...
        if (cpf.equals(compare)) {
            ...
            ListaDeAtendentes novaLista = new ListaDeAtendentes();
            novaLista.setVisible(true);
            novaLista.setLocationRelativeTo(null);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaDeAtendentes().setVisible(true);
            }
        });
    }
