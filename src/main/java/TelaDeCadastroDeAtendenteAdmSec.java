...
public class TelaDeCadastroDeAtendenteAdmSec extends javax.swing.JFrame {

    public TelaDeCadastroDeAtendenteAdmSec() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        psdTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                psdTextFieldActionPerformed(evt);
            }
        });
        jPanel1.add(psdTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 190, 210, 30));
        ...
        jPanel1.add(label8, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 170, 210, -1));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, 210, 90));
        ...
        jPanel1.add(nomeTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 80, 200, 30));
        ...
        jPanel1.add(label13, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 210, -1));
        ...
        jPanel1.add(chTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 130, 210, 30));
    ...
    private void psdTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_psdTextFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_psdTextFieldActionPerformed

    private void salvarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarButtonActionPerformed
        //Cadastramento de atendente
        boolean empty = funcaoTextField.getText().isEmpty();
        boolean nomeEmpty = psdTextField.getText().isBlank();
        String sexo = null;
        ...
        if (nomeEmpty == true || empty == true) {
            JOptionPane.showMessageDialog(null, "Por favor, verifique as informações");

        } else {
            String nome = psdTextField.getText();
            ...
            TelaAdmSec VoltarADM = new TelaAdmSec();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeCadastroDeAtendenteAdmSec().setVisible(true);
            }
        });
    }
