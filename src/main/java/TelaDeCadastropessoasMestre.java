...
public class TelaDeCadastropessoasMestre extends javax.swing.JFrame {

    public TelaDeCadastropessoasMestre() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(enderecoTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(label2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(numeroTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(bairroTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(complementoTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, -1, -1));
        ...
        jPanel1.add(telefoneTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 220, 200, 30));
        ...
        jPanel1.add(idadeTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, 200, 30));

        label1.setAlignment(java.awt.Label.CENTER);
        label1.setBackground(new java.awt.Color(7, 87, 117));
        label1.setForeground(new java.awt.Color(255, 255, 255));
        label1.setText("Idade");
        jPanel1.add(label1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 200, 30));

        label6.setAlignment(java.awt.Label.CENTER);
        label6.setBackground(new java.awt.Color(7, 87, 117));
        label6.setForeground(new java.awt.Color(255, 255, 255));
        label6.setText("Nome");
        jPanel1.add(label6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, 200, 30));

        label7.setAlignment(java.awt.Label.CENTER);
        label7.setBackground(new java.awt.Color(7, 87, 117));
        label7.setForeground(new java.awt.Color(255, 255, 255));
        label7.setText("CPF");
        jPanel1.add(label7, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 200, 20));

        label8.setAlignment(java.awt.Label.CENTER);
        label8.setBackground(new java.awt.Color(7, 87, 117));
        label8.setForeground(new java.awt.Color(255, 255, 255));
        label8.setText("Telefone");
        jPanel1.add(label8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 190, 200, 30));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-130, 50, 430, 250));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Pessoa p = new Pessoa(nome, idade, cpf, endereco, cep, numero, bairro, complemento, telefone);
            p.inserirPaciente1Dose();

        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Falha ao efetuar cadastro");
        }
        //Escolha para cadastrar mais uma pessoa ou não.
        int result = JOptionPane.showConfirmDialog(null, "Deseja cadastrar outra pessoa?", null, JOptionPane.YES_NO_OPTION);
        if (result == JOptionPane.YES_OPTION) {
            TelaDeCadastropessoasMestre telaNovoCadastro = new TelaDeCadastropessoasMestre();
            telaNovoCadastro.setVisible(true);
            setLocationRelativeTo(null);
            this.dispose();
        } else {
            TelaAdmSec voltaPainelAdm = new TelaAdmSec();
            voltaPainelAdm.setVisible(true);
            this.dispose();
        }
