...
public class TelaPesquisaPessoaA extends javax.swing.JFrame {

    public TelaPesquisaPessoaA() {
        initComponents();
...
//Auto preencher info.
    ...
    public TelaPesquisaPessoaA(Pessoa paciente) {
        initComponents();
    ...
    //Hora automatica ao confirmar vacina
    ...
    private void initComponents() {
        ...
        jPanel1.add(nomeTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 200, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        TelaDeVacinadosAtendente voltarAtendente = new TelaDeVacinadosAtendente();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPesquisaPessoaA().setVisible(true);
            }
        });
    }
