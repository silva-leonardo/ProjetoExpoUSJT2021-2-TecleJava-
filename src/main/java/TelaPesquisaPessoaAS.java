...
public class TelaPesquisaPessoaAS extends javax.swing.JFrame {

    public TelaPesquisaPessoaAS() {
        initComponents();
...
//Auto preencher info.
    ...
    public TelaPesquisaPessoaAS(Pessoa paciente) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        TelaDeVacinadosAdmSec voltarTelaVacAS = new TelaDeVacinadosAdmSec();

        voltarTelaVacAS.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPesquisaPessoaAS().setVisible(true);
            }
        });
    }
